...
@section('title', trans('stats::stats.settings'))
@section('page_header', trans('stats::stats.settings'))

@section('left')
<div class="box box-success box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">{{ trans('stats::stats.settings') }}</h3>
    </div>
    <form method="POST" action="{{ route('stats.savesettings')  }}" class="form-horizontal">
        <div class="box-body">
            {{ csrf_field() }}
...
<div class="box box-success box-solid">
    ...
    <div class="box-body">
        <div class="col-sm-12">
            <p><label>Ore value modifier:</label> This is a modifier used on the base costs of the ore/minerals/goo to adjust for inflation/deflation during the stats period.  Normally this is 90-95% </p>
        </div>
        <div class="col-sm-12">
